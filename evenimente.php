...
<body>
    ...
    echo "<td><a href='evenimentemodificare.php?id=" . $row->id . "'>Modificare</a></td>";
    echo "<td><a href='evenimentestergere.php?id=" .$row->id . "'>Stergere</a></td>";
    echo "</tr>";
    }
    echo "</table>";
    }
    ...
    $mysqli->close();
    ?>
<a href="evenimenteinserare.php">Adaugarea unei noi inregistrari
</body>
</html>